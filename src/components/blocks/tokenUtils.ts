...
const COMPACT_SPACING_OVERRIDES: Partial<Record<keyof typeof gmSpacing, keyof typeof gmSpacing>> = {
  ...
  "gm-spacing-hero-frame-inline": "gm-spacing-shell-inline",
  "gm-spacing-inline-none": "gm-spacing-inline-none",
  "gm-spacing-shell-block": "gm-spacing-shell-block",
  "gm-spacing-hero-card": "gm-spacing-card-lg",
  "gm-spacing-hero-frame-block": "gm-spacing-shell-block",
  "gm-spacing-grid-relaxed": "gm-spacing-grid",
  "gm-spacing-grid-spacious": "gm-spacing-grid-relaxed",
